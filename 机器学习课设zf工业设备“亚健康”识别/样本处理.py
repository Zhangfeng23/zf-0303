...
def reduce_mem_usage(df):
    ...
    print('Memory usage of dataframe is {:.2f} MB'.format(start_mem)) #字符串函数
...
# 读取数据
data = pd.read_csv(r"D:/机器学习大作业/数据集/train.csv")
X_test = pd.read_csv(r"D:/机器学习大作业/数据集/test.csv")
...
data_reset.to_csv(r"D:/机器学习大作业/train_samples.csv", index=False)
print(data_reset.head())

temp = pd.read_csv(r"D:/机器学习大作业/train_samples.csv")
